namespace Kontent.Ai.Urls.Delivery.QueryParameters.Filters
{
    ...
    /// </summary>
    public sealed class EqualsFilter<T> : Filter<T>
    {
        /// <summary>
        ...
        public EqualsFilter(string elementOrAttributePath, T value) : base(elementOrAttributePath, value)
        {
            Operator = "[eq]";
        }
    }
    ...
    /// Represents a filter that matches a content item if the specified content element or system attribute has the specified value.
    /// </summary>
    public sealed class EqualsFilter : Filter<string>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EqualsFilter"/> class.
        /// </summary>
