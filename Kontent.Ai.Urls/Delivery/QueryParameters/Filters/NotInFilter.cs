namespace Kontent.Ai.Urls.Delivery.QueryParameters.Filters
{
    ...
    /// </summary>
    public sealed class NotInFilter<T> : Filter<T>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NotInFilter{T}"/> class.
        /// </summary>
        ...
        public NotInFilter(string elementOrAttributePath, params T[] values) : base(elementOrAttributePath, values)
        {
            Operator = "[nin]";
        }
    }
    ...
    /// Represents a filter that matches a content item if the specified content element or system attribute has a value that doesn't match a value in the specified list.
    /// </summary>
    public sealed class NotInFilter : Filter<string>
    {
        /// <summary>
