namespace Kontent.Ai.Urls.Delivery.QueryParameters.Filters
{
    ...
    /// </summary>
    public sealed class AnyFilter<T> : Filter<T>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnyFilter{T}"/> class.
        /// </summary>
        ...
        public AnyFilter(string elementOrAttributePath, params T[] values) : base(elementOrAttributePath, values)
        {
            Operator = "[any]";
        }
    }
    ...
    /// This filter is applicable to array values only, such as sitemap location or value of Linked Items, Taxonomy and Multiple choice content elements.
    /// </summary>
    public sealed class AnyFilter : Filter<string>
    {
        /// <summary>
