namespace Kontent.Ai.Urls.Delivery.QueryParameters.Filters
{
    ...
    /// </summary>
    public sealed class GreaterThanFilter<T> : Filter<T>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GreaterThanFilter{T}"/> class.
        /// </summary>
        ...
        public GreaterThanFilter(string elementOrAttributePath, T value) : base(elementOrAttributePath, value)
        {
            Operator = "[gt]";
        }
    }
    ...
    /// Represents a filter that matches a content item if the specified content element or system attribute has a value that is greater than the specified value.
    /// </summary>
    public sealed class GreaterThanFilter : Filter<string>
    {
        /// <summary>
