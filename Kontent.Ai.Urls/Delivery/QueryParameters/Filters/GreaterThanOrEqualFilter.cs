namespace Kontent.Ai.Urls.Delivery.QueryParameters.Filters
{
    ...
    /// </summary>
    public sealed class GreaterThanOrEqualFilter<T> : Filter<T>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GreaterThanOrEqualFilter{T}"/> class.
        /// </summary>
        ...
        public GreaterThanOrEqualFilter(string elementOrAttributePath, T value) : base(elementOrAttributePath, value)
        {
            Operator = "[gte]";
        }
    }
    ...
    /// Represents a filter that matches a content item if the specified content element or system attribute has a value that is greater than or equal to the specified value.
    /// </summary>
    public sealed class GreaterThanOrEqualFilter : Filter<string>
    {
        /// <summary>
