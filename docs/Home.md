...
- ✔️ [Use `HttpClientFactory`](https://github.com/kontent-ai/delivery-sdk-net/blob/migration/docs/Registering-the-DeliveryClient-to-the-IServiceCollection-in-ASP.NET-Core.md#httpclientfactory) for increased performance and stability of your app
...
* **Customization and extensibility**
  ...
  * [Retrieve modular content from API response](https://github.com/kontent-ai/delivery-sdk-net/blob/migration/docs/Retrieve-modular-content-from-API-response.md)
* **Unit testing**
