...
- `CacheType` - currently allows to select from [`Memory` and `Distributed`](https://github.com/kontent-ai/delivery-sdk-net/blob/master/Kontent.Ai.Delivery.Caching/CacheTypeEnum.cs)
...
You can also provide your own version of the caching mechanism by implementing the [`IDeliveryCacheManager`](https://github.com/kontent-ai/delivery-sdk-net/blob/master/Kontent.Ai.Delivery.Abstractions/IDeliveryCacheManager.cs) interface.