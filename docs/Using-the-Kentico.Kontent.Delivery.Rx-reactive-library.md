The [DeliveryObservableProxy class](https://github.com/Kentico/delivery-sdk-net/blob/master/Kentico.Kontent.Delivery.Rx/DeliveryObservableProxy.cs) provides a reactive way of retrieving content from Kontent.
