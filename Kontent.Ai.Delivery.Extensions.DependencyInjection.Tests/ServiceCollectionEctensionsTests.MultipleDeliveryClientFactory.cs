...
namespace Kontent.Ai.Delivery.Extensions.DependencyInjection.Tests
{
    public partial class ServiceCollectionExtensionsTests
    {
        public class MultipleDeliveryClientFactory
        {
            ...
            {
                Assert.Throws<ArgumentNullException>(() => _serviceCollection.AddMultipleDeliveryClientFactory(factoryBuilder => factoryBuilder.AddDeliveryClient(_correctName, null).Build()));
            }
