...
namespace KenticoCloud.Delivery
{
    ...
    public sealed class ContentItem
    {
        ...
        public IEnumerable<ContentItem> GetModularContent(string elementCodename)
        {
            ...
            return contentItemCodenames.Where(codename => _modularContentSource[codename] != null).Select(codename => new ContentItem(_modularContentSource[codename], _modularContentSource, _contentLinkUrlResolver, _codeFirstModelProvider));
        }
