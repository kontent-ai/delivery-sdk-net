...
namespace Kontent.Ai.Delivery.Caching
{
    ...
    public class DeliveryClientCache : IDeliveryClient
    {
        ...
        public Task<IDeliverySyncV2InitResponse> PostSyncV2InitAsync(IEnumerable<IQueryParameter> parameters = null)
        {
            return _deliveryClient.PostSyncV2InitAsync(parameters);
        }
        ...
        public Task<IDeliverySyncV2Response> GetSyncV2Async(string continuationToken)
        {
            return _deliveryClient.GetSyncV2Async(continuationToken);
        }
