...
internal sealed class ContentLinkResolver(IContentLinkUrlResolver contentLinkUrlResolver)
{
    ...
    public IContentLinkUrlResolver ContentLinkUrlResolver { get; } = contentLinkUrlResolver ?? throw new ArgumentNullException(nameof(contentLinkUrlResolver));
