...
namespace Kontent.Ai.Delivery
{
    ...
    internal sealed class DeliveryClient : IDeliveryClient
    {
        ...
        public async Task<IDeliverySyncV2InitResponse> PostSyncV2InitAsync(IEnumerable<IQueryParameter> parameters = null)
        {
            var endpointUrl = UrlBuilder.GetSyncV2InitUrl(parameters);
            var response = await GetDeliveryResponseAsync(endpointUrl, httpMethod: HttpMethod.Post);
