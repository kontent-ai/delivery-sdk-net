...
internal class InlineContentItemsResolverFactory
{
    ...
    private class SimpleResolver<TContentItem>(Func<TContentItem, string> resultSelector) : IInlineContentItemsResolver<TContentItem>
    {
        private readonly Func<TContentItem, string> _resultSelector = resultSelector;
