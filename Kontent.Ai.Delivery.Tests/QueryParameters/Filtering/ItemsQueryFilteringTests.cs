    ...
    public class ItemsQueryFilteringTests
    {
        ...
        public async Task ItemsQuery_Where_ComposesFilterParameter()
        {
            ...
            var result = await client.GetItems<IElementsModel>()
                .Where(new Api.QueryBuilders.Filtering.ItemFilters().Equals(Abstractions.QueryBuilders.Filtering.SystemPath.Type(), Abstractions.QueryBuilders.Filtering.Scalar.From("article")))
                .ExecuteAsync();
