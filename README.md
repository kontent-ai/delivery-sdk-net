...
#### Source Generation with ContentTypeCodename Attribute

Alternatively, you can use the `[ContentTypeCodename]` attribute to register your model classes for compile-time type resolution. This approach provides:
...
Then decorate your model classes:
