...
namespace Kontent.Ai.Delivery.Abstractions
{
    ...
    public static class DeliveryClientExtensions
    {
        ...
        public static Task<IDeliverySyncV2InitResponse> PostSyncV2InitAsync(this IDeliveryClient client, params IQueryParameter[] parameters)
        {
            return client.PostSyncV2InitAsync(parameters);
        }
